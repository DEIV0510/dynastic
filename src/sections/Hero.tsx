...
export default function Hero() {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-void pb-4 pt-28 sm:pt-32 lg:pb-10 lg:pt-36">
      {/* lienzo */}
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="animate-pulseGlow absolute left-1/2 top-[8%] h-[560px] w-[980px] max-w-[150vw] -translate-x-1/2 rounded-full bg-electric/[0.22] blur-[140px]" />
      ...
      <div className="container-x">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="h-display mt-5 text-[clamp(2.4rem,8.2vw,5.6rem)] leading-[1.03] animate-[fade-up_.8s_ease-out_.06s_both]">
            Tecnología que <span className="text-silver-sheen">eleva</span>
            <br className="hidden sm:block" /> tu estilo
          </h1>

          <p className="mx-auto mt-6 max-w-xl text-[15px] leading-relaxed text-silver-400 sm:text-base animate-[fade-up_.8s_ease-out_.14s_both]">
            Innovación, diseño y funcionalidad para una vida más conectada.
          </p>

          <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row animate-[fade-up_.8s_ease-out_.2s_both]">
          ...
          <p className="mt-6 inline-flex items-center gap-2 text-[12px] text-silver-500 animate-[fade-up_.8s_ease-out_.26s_both]">
        ...
        <div className="relative mt-10 sm:mt-14">
          <div ref={parallax} className="relative mx-auto max-w-5xl will-change-transform">
            <div
              aria-hidden
        ...
        <ul className="mx-auto mt-10 flex max-w-3xl flex-wrap items-center justify-center gap-2.5 sm:mt-12 sm:gap-3">
          {[
