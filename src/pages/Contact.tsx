          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_1.1fr] lg:gap-14">
            <Reveal>
              <div className="card p-7 sm:p-8">
                ...
                <h2 className="mt-3 font-display text-xl font-bold text-white">WhatsApp</h2>
                ...
                <ul className="mt-8 space-y-4 border-t border-hair pt-6 text-[14px]">
                  ...
                  <li>
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-start gap-3 text-silver-400 transition-colors hover:text-white"
                    >
            ...
            <Reveal delay={90}>
              ...
              >
                ...
                <h2 className="mt-3 font-display text-xl font-bold text-white">Arma tu mensaje</h2>
