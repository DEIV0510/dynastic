            ...
            <Reveal>
              ...
              <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-silver-400">
                <p>
                  ...
                  útiles a más personas, construyendo una marca moderna, confiable y preparada para
                  crecer.
                </p>
                <p>
                  Operamos desde {site.location}, con venta online y atención directa por WhatsApp.
                  Eso nos permite responder rápido, conseguir lo que buscas y acompañarte antes y
            ...
            {MILESTONES.map((m, i) => (
              <Reveal as="li" key={m.step} delay={i * 70} className="h-full">
                <div className="card h-full p-6">
                  ...
                  <h3 className="mt-3 font-display text-[15px] font-bold uppercase tracking-wide text-white">
                    {m.title}
                  </h3>
