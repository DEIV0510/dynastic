                ...
                <div className="plate relative overflow-hidden rounded-[28px] border border-hair shadow-plate">
                  ...
                  <div className="relative grid aspect-square place-items-center p-8 sm:p-12">
                    <ProductImage
                      ...
                      priority
                      className="max-h-full w-auto max-w-full object-contain drop-shadow-[0_34px_40px_rgba(0,0,0,.9)]"
                    />
                  </div>
                  {offer && (
                    ...
                    <li key={g}>
                      <button
                        ...
                        className={`plate grid h-20 w-20 place-items-center overflow-hidden rounded-xl border p-2 transition-colors ${
                          i === shot ? 'border-electric/70' : 'border-hair hover:border-electric/40'
                        }`}
                      >
                        <ProductImage
                          name={g}
                      ...
                      <button
                        ...
                        className={`rounded-full border px-4 py-2 text-[12px] transition-colors ${
                          variant === v.id
                            ...
                            : 'border-hair text-silver-400 hover:text-white'
                        }`}
                      >
                        {v.label}
                      </button>
                ...
                {priced && !sold && (
                  <div className="flex h-14 items-center rounded-full border border-hair px-2">
                    <button
                      ...
                      className="grid h-10 w-10 place-items-center rounded-full text-silver-300 hover:text-white"
                    >
                      <IconMinus className="h-4 w-4" />
                    </button>
                    <span
                      className="w-9 text-center font-display font-bold text-white"
                      aria-live="polite"
                    >
                      {qty}
                    </span>
          ...
          <div className="mt-20 border-t border-hair pt-14">
            <div className="mb-8 flex items-end justify-between gap-4">
              <div>
                ...
                <h2 className="h-display mt-3 text-[clamp(1.5rem,4vw,2.4rem)]">Sigue explorando</h2>
              </div>
