                    ...
                    <div className="card glow-ring flex h-full flex-col transition-[box-shadow,border-color] duration-300 group-hover:border-electric/40 group-hover:shadow-glow">
                      ...
                      <div className="flex flex-1 flex-col gap-1 border-t border-hair p-4">
                        <div className="flex items-baseline justify-between gap-2">
                          <h2 className="font-display text-[14px] font-bold uppercase tracking-wide text-heading">
                            {c.name}
                          </h2>
          ...
          <div className="container-x">
            {items.length === 0 ? (
              <div className="card mx-auto max-w-lg p-10 text-center">
                <h2 className="font-display text-lg font-bold text-heading">Muy pronto</h2>
              ...
              <ul className="no-scrollbar -mx-5 flex gap-2.5 overflow-x-auto px-5 sm:mx-0 sm:flex-wrap sm:px-0">
                {others.map((c) => (
                  <li key={c.slug}>
                    <Link
                      to={`/categoria/${c.slug}`}
                      className="chip shrink-0 whitespace-nowrap hover:border-electric/50 hover:text-heading"
                    >
                      {c.name}
                    </Link>
                  </li>
