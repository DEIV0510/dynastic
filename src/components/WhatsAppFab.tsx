...
export default function WhatsAppFab() {
  return (
    <a
      ...
      className="wa-fab group fixed right-4 z-40 flex h-14 items-center gap-0 overflow-hidden rounded-full bg-gradient-to-br from-[#22C55E] to-[#16A34A] pl-4 pr-4 text-heading shadow-[0_14px_38px_-12px_rgba(34,197,94,.85)] transition-[padding] duration-300 sm:right-6 sm:hover:pr-6"
    >
